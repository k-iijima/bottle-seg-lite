...
tar czf runpod/attr_inputs.tar.gz \
  -C /work/datasets \
    ...
    pet_bottle/annotations/instances_all_sam3merge.json \
    pet_bottle/annotations/instances_train_sam3merge.json \
    pet_bottle/annotations/instances_val_sam3merge.json \
    pet_bottle/annotations/instances_test_sam3merge.json \
  -C /work \
