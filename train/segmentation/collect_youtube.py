...
出力（非破壊・ステージング）:
  datasets/pet_bottle/images/all/youtube_<vid>_<frame>.jpg
  datasets/pet_bottle/annotations/instances_youtube_sam3merge.json   (COCO: bottle のみ)
  datasets/pet_bottle/metadata/manifest_youtube.csv
  datasets/pet_bottle/qa_youtube/preview_*.jpg
